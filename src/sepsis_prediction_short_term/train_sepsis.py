...
PATH_TRAIN_SEQS = "./../../data/sepsis/processed_short_term/sepsis.seqs.train"
PATH_TRAIN_LABELS = "./../../data/sepsis/processed_short_term/sepsis.labels.train"
PATH_VALID_SEQS = "./../../data/sepsis/processed_short_term/sepsis.seqs.validation"
PATH_VALID_LABELS = "./../../data/sepsis/processed_short_term/sepsis.labels.validation"
PATH_TEST_SEQS = "./../../data/sepsis/processed_short_term/sepsis.seqs.test"
PATH_TEST_LABELS = "./../../data/sepsis/processed_short_term/sepsis.labels.test"
